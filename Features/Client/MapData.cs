...
public static class MapData
{
    ...
    public readonly static List<MapName> AllMapInfo = new()
    {
        ...
        new() { English="ID_M_MP_LEVEL_SCAR", Chinese="圣康坦的伤痕", Team1="UK", Team2="GER", Image=@"\Assets\Images\Client\Maps\MP_Scar_LandscapeLarge-ee25fbd6.jpg" },
        ...
        new() { English="ID_M_MP_LEVEL_TRENCH", Chinese="尼维尔之夜", Team1="FRA", Team2="GER", Image=@"\Assets\Images\Client\Maps\MP_Trench_LandscapeLarge-dbd1248f.jpg" },
        ...
        new() { English="ID_M_MP_LEVEL_ISLANDS", Chinese="阿尔比恩", Team1="RUS", Team2="GER", Image=@"\Assets\Images\Client\Maps\MP_Islands_LandscapeLarge-c9d8272b.jpg" },
        new() { English="ID_M_MP_LEVEL_RAVINES", Chinese="武普库夫山口", Team1="RUS", Team2="AHU", Image=@"\Assets\Images\Client\Maps\MP_Ravines_LandscapeLarge-1fe0d3f6.jpg" },
        ...
        new() { English="ID_M_MP_LEVEL_TSARITSYN", Chinese="察里津", Team1="RUS", Team2="BOL", Image=@"\Assets\Images\Client\Maps\MP_Tsaritsyn_LandscapeLarge-2dbd3bf5.jpg" },
        new() { English="ID_M_MP_LEVEL_VOLGA", Chinese="窝瓦河", Team1="RUS", Team2="BOL", Image=@"\Assets\Images\Client\Maps\MP_Volga_LandscapeLarge-6ac49c25.jpg" },
        ...
        new() { English="ID_M_MP_LEVEL_RIVER", Chinese="卡波雷托", Team1="ITA", Team2="AHU", Image=@"\Assets\Images\Client\Maps\MP_River_LandscapeLarge-21443ae9.jpg" },
        new() { English="ID_M_MP_LEVEL_ALPS", Chinese="剃刀边缘", Team1="UK", Team2="GER", Image=@"\Assets\Images\Client\Maps\MP_Alps_LandscapeLarge-7ab30e3e.jpg" },
        new() { English="ID_M_MP_LEVEL_BLITZ", Chinese="伦敦的呼唤：夜袭", Team1="UK", Team2="GER", Image=@"\Assets\Images\Client\Maps\MP_Blitz_LandscapeLarge-5e26212f.jpg" },
        new() { English="ID_M_MP_LEVEL_LONDON", Chinese="伦敦的呼唤：灾祸", Team1="UK", Team2="GER", Image=@"\Assets\Images\Client\Maps\MP_London_LandscapeLarge-0b51fe46.jpg" }
    };
}
